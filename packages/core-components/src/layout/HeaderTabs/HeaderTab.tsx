...
const Tab = React.forwardRef(function Tab(props: CustomTabProps, ref: any) {
  ...
  return (
    <>
      <ButtonBase
        ...
        data-testid={testId}
      >
        <span className={classes?.wrapper}>{label}</span>
        <ExpandMoreIcon />
      </ButtonBase>
      <Popover
        id={submenuId}
...
// @ts-ignore
export const TabUI = withStyles(styles, { name: 'MuiTab' })(Tab);
